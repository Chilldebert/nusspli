    ...
    <table>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="hidden" name="collection" id="collection" value="{$video.collection}" />
            {$lang.collection} {html_options name="collection" options=$collection selected=$video.collection}
          </td>
        </tr>
