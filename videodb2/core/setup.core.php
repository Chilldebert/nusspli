 ...
 * @version $Id: setup.core.php,v 1.11 2010/02/14 11:46:21 andig2 Exp $
 */
...
$SETUP_GLOBAL = array('language', 'autoid', 'mediadefault', 'collectiondefault','langdefault', 
...
$SETUP_USER   = array('language', 'mediadefault', 'collectiondefault', 'langdefault', 'filterdefault', 
...
function setup_mkOptions($isprofile = false)
{
	...
	$setup[] = setup_addOption($isprofile, 'collectiondefault', 'dropdown', setup_getCollection());
