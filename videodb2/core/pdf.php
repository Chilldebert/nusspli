 ...
 * @version $Id: pdf.php,v 1.34 2010/11/05 10:32:10 andig2 Exp $
 */
...
{
	if (preg_match("/^(blu-ray|bluray.1080p|bluray.720p|HDRip|HDRip.LD|HDRip.MD)/i", $mediatype, $matches))
	{
		$type_image = 'blu-ray.png';
	}
	elseif (preg_match("(TVRip)", $mediatype, $matches))
	{
		$type_image = 'tv.png';
	}
	else $type_image = 'dvd.png';
