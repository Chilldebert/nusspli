 ...
 * @version $Id: output.php,v 1.26 2009/03/23 15:36:39 andig2 Exp $
 */
...
/**
 * Display selectbox with available Collections
 *
 * @todo is this still used? can it be replaced by template code?
 * @author <scherzinger,david@web.de>
 * @return string   HTML of selectbox
 */
function out_collection($prefix = null)
{
	global $config;
    ...
    // build associative array
    # array('0' => '') + 
    $collection = is_array($prefix) ? $prefix : array();
    $collection = $collection + array_associate($result, 'id', 'name');
