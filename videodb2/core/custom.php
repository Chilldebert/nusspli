 ...
 */
function custom_collection_output($cn,$cv)
{
	return '<a href="search.php?q='.$cv.'&fields='.$cn.'">'.custom_text_output($cn,$cv).' </a>';
}
/**
 * Custom Type: Collection
 *
 * Add your movies to Collections
 * 
 * @author <scherzinger.david@web.de>
 */
function custom_collection_input($cn,$cv)
{
	return custom_text_input($cn,$cv);
}
