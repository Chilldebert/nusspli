...
$imdb_set_fields    = array('md5','title','subtitle','language','diskid','mediatype', 'collection', 'comment','disklabel',
...
function prepareSQL($data, $setonly = false)
{
    ...
    if (empty($collection)) $collection = $config['collectiondefault'];
